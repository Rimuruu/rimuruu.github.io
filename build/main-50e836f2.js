...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			a = element("a");
			img = element("img");
			add_location(h2, file$2, 12, 0, 179);
			add_location(br, file$2, 13, 28, 225);
			attr_dev(p, "class", "text-light");
			add_location(p, file$2, 13, 0, 197);
			...
			add_location(img, file$2, 14, 15, 263);
			attr_dev(a, "href", /*link*/ ctx[3]);
			add_location(a, file$2, 14, 0, 248);
		...
		p: function update(ctx, [dirty]) {
			...
			if (dirty & /*info*/ 2) set_data_dev(t2, /*info*/ ctx[1]);
...
function instance$2($$self, $$props, $$invalidate) {
	...
	return [title, info, description, link, background];
}
...
class Cadre extends SvelteComponentDev {
	constructor(options) {
		...
		if (/*background*/ ctx[4] === undefined && !("background" in props)) {
...
var Snake = {
	title: "Snake",
	info: "2018 || C",
	description: "Projet de DUT Informatique",
...
const func = () => import('./AnimatedBG-98face53.js');
...
export { SvelteComponentDev as S, attr_dev as a, add_location as b, insert_dev as c, dispatch_dev as d, element as e, detach_dev as f, app as g, init as i, noop as n, safe_not_equal as s, validate_slots as v };
//# sourceMappingURL=main-50e836f2.js.map
