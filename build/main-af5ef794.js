...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(img0, file, 81, 0, 1524);
			attr_dev(h2, "class", "text-center mt-5");
			add_location(h2, file, 82, 0, 1572);
			...
			add_location(div3, file, 79, 0, 1411);
		},
...
function instance($$self, $$props, $$invalidate) {
	...
	Object.keys($$props).forEach(key => {
		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1.warn(`<Aside> was created with unknown prop '${key}'`);
	});
...
/* src\pages\History.svelte generated by Svelte v3.24.0 */
...
function create_fragment$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			t7 = space();
			h51 = element("h5");
			h51.textContent = "2ème année DUT informatique en programme d'échange";
			t9 = space();
			p1 = element("p");
			p1.textContent = "Université du Québec à Chicoutimi";
			t11 = space();
			h52 = element("h5");
			h52.textContent = "1ère année DUT Informatique";
			t13 = space();
			p2 = element("p");
			p2.textContent = "IUT de Sénart-Fontainebleau, Lieusaint";
			t15 = space();
			h53 = element("h5");
			h53.textContent = "Baccalauréat scientifique";
			t17 = space();
			p3 = element("p");
			t18 = text("Lycée de Montegron ");
			br = element("br");
			t19 = text("Option sciences de la vie et de la terre, Spécialité informatique et sciences du numérique.");
			attr_dev(h20, "class", "svelte-gonkwn");
			add_location(h20, file$1, 2684, 0, 67265);
			attr_dev(h50, "class", "ml-5 text-light svelte-gonkwn");
			add_location(h50, file$1, 2685, 0, 67287);
			attr_dev(p0, "class", "ml-5 text-italic text-muted svelte-gonkwn");
			add_location(p0, file$1, 2686, 4, 67364);
			attr_dev(h21, "class", "svelte-gonkwn");
			add_location(h21, file$1, 2688, 0, 67504);
			attr_dev(h51, "class", "ml-5 text-light svelte-gonkwn");
			add_location(h51, file$1, 2689, 0, 67525);
			attr_dev(p1, "class", "ml-5 text-italic text-muted svelte-gonkwn");
			add_location(p1, file$1, 2690, 4, 67614);
			attr_dev(h52, "class", "ml-5 text-light svelte-gonkwn");
			add_location(h52, file$1, 2691, 0, 67693);
			attr_dev(p2, "class", "ml-5 text-italic text-muted svelte-gonkwn");
			add_location(p2, file$1, 2692, 4, 67759);
			attr_dev(h53, "class", "ml-5 text-light svelte-gonkwn");
			add_location(h53, file$1, 2693, 0, 67842);
			attr_dev(br, "class", "svelte-gonkwn");
			add_location(br, file$1, 2694, 62, 67964);
			attr_dev(p3, "class", "ml-5 text-italic text-muted svelte-gonkwn");
			add_location(p3, file$1, 2694, 4, 67906);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
/* src\components\Cadre.svelte generated by Svelte v3.24.0 */
const file$2 = "src\\components\\Cadre.svelte";
...
function create_else_block$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(img, file$2, 51, 0, 1205);
			attr_dev(button, "class", "play svelte-1v4ejb2");
			add_location(button, file$2, 50, 0, 1148);
		},
		m: function mount(target, anchor) {
...
function create_if_block_1$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(img, "height", "50px");
			attr_dev(img, "width", "50px");
			add_location(img, file$2, 44, 15, 1047);
			attr_dev(a, "href", /*link*/ ctx[3]);
			add_location(a, file$2, 44, 0, 1032);
		},
		m: function mount(target, anchor) {
...
function create_if_block$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(button, file$2, 69, 0, 1422);
			attr_dev(div0, "class", "modal-content-c svelte-1v4ejb2");
			add_location(div0, file$2, 68, 0, 1391);
			attr_dev(div1, "class", "modal-c svelte-1v4ejb2");
			add_location(div1, file$2, 66, 0, 1366);
		},
		m: function mount(target, anchor) {
			...
			append_dev(div0, t1);
			mount_component(loadable, div0, null);
			current = true;
...
function create_loading_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span, file$2, 73, 2, 1722);
			attr_dev(div1, "class", "spinner-border text-light ");
			attr_dev(div1, "role", "status");
			add_location(div1, file$2, 72, 69, 1664);
			attr_dev(div2, "class", "bg-dark bg-not-load text-center align-middle spin");
			add_location(div2, file$2, 72, 6, 1601);
			attr_dev(div0, "slot", "loading");
			add_location(div0, file$2, 71, 4, 1573);
		},
		m: function mount(target, anchor) {
...
function create_fragment$3(ctx) {
	...
	function select_block_type(ctx, dirty) {
		if (/*link*/ ctx[3] != "tetris") return create_if_block_1$1;
		return create_else_block$1;
	}

	let current_block_type = select_block_type(ctx);
	let if_block0 = current_block_type(ctx);
	let if_block1 = /*isOpen*/ ctx[4] && create_if_block$1(ctx);
	...
	const block = {
		c: function create() {
			...
			add_location(h2, file$2, 41, 0, 940);
			add_location(br, file$2, 42, 28, 986);
			attr_dev(p, "class", "text-light");
			add_location(p, file$2, 42, 0, 958);
			attr_dev(div, "class", "text-center border rounded p-5");
			add_location(div, file$2, 40, 0, 894);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
const func = () => import('./Tetris-f7a82b07.js');
...
function instance$3($$self, $$props, $$invalidate) {
	...
	let isOpen = false;
	const writable_props = ["title", "info", "description", "link", "background"];
...
class Cadre extends SvelteComponentDev {
	constructor(options) {
		...
		if (/*background*/ ctx[5] === undefined && !("background" in props)) {
			console.warn("<Cadre> was created without expected prop 'background'");
		}
	}
...
/* src\pages\Realisation.svelte generated by Svelte v3.24.0 */

const { Object: Object_1, console: console_1$1 } = globals;
const file$3 = "src\\pages\\Realisation.svelte";
...
function create_fragment$4(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$3, 12, 0, 222);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function instance$4($$self, $$props, $$invalidate) {
	...
	Object_1.keys($$props).forEach(key => {
		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$1.warn(`<Realisation> was created with unknown prop '${key}'`);
	});
...
function instance$5($$self, $$props, $$invalidate) {
	...
	function div0_binding($$value) {
		binding_callbacks[$$value ? "unshift" : "push"](() => {
			main = $$value;
			(($$invalidate(0, main), $$invalidate(2, isOpen)), $$invalidate(1, container));
		});
	}
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*isOpen, container*/ 6) {
			 {
				if (isOpen) $$invalidate(0, main.style.width = container - 450 + "px", main);
			}
		}
	};
...
/* src\Rimuruu.svelte generated by Svelte v3.24.0 */
const file$5 = "src\\Rimuruu.svelte";

// (41:4) <div slot="loading">
function create_loading_slot$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			span.textContent = "Loading...";
			attr_dev(span, "class", "sr-only");
			add_location(span, file$5, 42, 2, 1069);
			attr_dev(div1, "class", "spinner-border text-light ");
			attr_dev(div1, "role", "status");
			add_location(div1, file$5, 41, 69, 1011);
			attr_dev(div2, "class", "bg-dark bg-not-load text-center align-middle spin svelte-1k63b62");
			add_location(div2, file$5, 41, 6, 948);
			attr_dev(div0, "slot", "loading");
			add_location(div0, file$5, 40, 4, 920);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div0, anchor);
			append_dev(div0, div2);
...
function create_fragment$6(ctx) {
	...
	loadable = new Loadable({
			props: {
				loader: func$1,
				$$slots: { loading: [create_loading_slot$1] },
				$$scope: { ctx }
			},
			$$inline: true
		});
	...
	const block = {
		c: function create() {
			...
			t1 = space();
			create_component(loadable.$$.fragment);
			attr_dev(div0, "class", "container-fluid w-90 row-reverse mw-100 w-100 p-0 svelte-1k63b62");
			add_location(div0, file$5, 33, 0, 742);
			attr_dev(div1, "class", "container-fluid d-flex p-0 h-100 w-100 mw-100 min-vh-100");
			add_location(div1, file$5, 31, 0, 653);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
const func$1 = () => import('./AnimatedBG-b65ab2f6.js');
...
function instance$6($$self, $$props, $$invalidate) {
	...
	$$self.$capture_state = () => ({ Aside, Main, fly, tweened, Loadable });
	return [];
}
...
//# sourceMappingURL=main-af5ef794.js.map
